...
def run(
    *,
    ...
    out_dir = raw_dir / f"daily_basic_{year}_parts"
    ...
    progress = Progress(total=len(pending), label="daily_basic")
...
def main() -> int:
    ...
    p.add_argument("--start-date", default="20050101")
